...
Estimates are supposed to be a rough gauge of how difficult and/or time consuming a task will be. The numbers are the Fibonacci Sequence, 
...
for sub sections of the work. To make a nested Epic:
...
If you make a new issue for this sub Epic, follow the instructions for [Strategy 1 Make the issues in Zenhub](#strategy1.11.make1.the1.issues1.in1.zenhub), but in step 9 assign the issue to both Epics.
